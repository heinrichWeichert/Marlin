...
#define XY_COUNTERPART_BACKOFF_MM 5         // (mm) Backoff X after homing Y, and vice-versa
 ...
 */
  ...
  #define X_HYBRID_THRESHOLD     3000  // [mm/s]
  #define X2_HYBRID_THRESHOLD    100
  #define Y_HYBRID_THRESHOLD     3000
