...
#define STRING_CONFIG_H_AUTHOR "hwe" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "rev_6 Ender 5 Plus CoreXY"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 642, 932 }
 ...
 */
// #define Z_MIN_PROBE_PIN PC2 // z stallguard see pins_BTT_SKR_MINI_E3_V3_0.h
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 0, -10, -1.85 }
...
#define Z_PROBE_ERROR_TOLERANCE     30 // (mm) Tolerance for early trigger (<= -probe.offset.z + ZPET)
...
// :[-1,1]
//HWE a==x, b==y, b is left, a is right
#define X_HOME_DIR -1
#define Y_HOME_DIR 1
#define Z_HOME_DIR -1
//#define I_HOME_DIR -1
